...
/// <summary>
/// After adding the above C# script to your project, simply call scrollView.FocusOnItem( targetItem ).
/// To focus on that item smoothly, call StartCoroutine( scrollView.FocusOnItemCoroutine( targetItem, focusSpeed ) ).
...
public static class ScrollViewFocusFunctions
{
	...
	public static IEnumerator FocusOnItemCoroutine( this ScrollRect scrollView, RectTransform item, float speed, Action onComplete = null )
	{
